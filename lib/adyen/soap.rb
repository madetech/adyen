...
require 'adyen/soap/recurring_service'
...
module Adyen
  ...
  module SOAP
    ...
    #
    # @example
    #   response = Adyen::SOAP.authorise_payment(
    #     invoice.id,
    ...
    #
    # @example
    #   detail  = Adyen::SOAP.list_recurring_details(user.id).details.last[:recurring_detail_reference]
    #   payment = Adyen::SOAP.authorise_one_click_payment(
    #     invoice.id,
    #     { :currency => 'EUR', :value => invoice.amount },
    #     { :reference => user.id, :email => user.email, :ip => '8.8.8.8', :statement => 'invoice number 123456' },
    #     '737',
    ...
    #   authorize_response = Adyen::SOAP.authorise_recurring_payment(
    #     invoice.id,
    #     { :currency => 'EUR', :value => invoice.amount },
    #     { :reference => user.id, :email => user.email, :ip => '8.8.8.8', :statement => 'invoice number 123456' },
